/* to do:
-update for loop to encompass 720 minutes
-delete pointers
-consider NO checkstands
-consider ONE checkstand
-when using pointers, check for nullness
-refactor if time
*/
...
int main()
{
	...
	// start writing (and calculate avg. wait time along the way)
	int cum_wait_time = 0; 
	CsvWriter writer; 
